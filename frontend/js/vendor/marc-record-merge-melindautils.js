...
(function(root, factory) {
  ...
  function constructor(config) {
    ...
    function canMerge(preferredRecord, otherRecord) {
      ...
      if (recordsHaveSameId(preferredRecord, otherRecord)) {
        deferred.reject(mergeError("Both records have same record id"));
...
//      if (field1.ind2 !== field2.ind2) return false;
    ...
    function recordsHaveSameId(record1, record2) {

      return getRecordId(record1) == getRecordId(record2);
